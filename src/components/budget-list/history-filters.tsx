...
import { Search, SlidersHorizontal, Calendar, X, User } from 'lucide-react';
...
export function HistoryFilters(props: HistoryFiltersProps) {
    ...
    const hasActiveFilters =
        props.filterCategory !== 'all' || props.filterOwner !== 'all' || props.fromISO || props.toISO;
        ...
        <div className="space-y-4">
            ...
            {showFilters && (
                <Card className="rounded-[2.5rem] border-none shadow-lg animate-in fade-in slide-in-from-top-2 duration-300 overflow-hidden">
                    <CardContent className="pl-6 pr-6 py-6 space-y-5">
                        <div className="grid grid-cols-2 gap-4">
                            <div className="space-y-1">
                                ...
                                <select
                                    className="w-full h-12 rounded-2xl bg-muted/50 border-none text-sm px-4 outline-none appearance-none font-sans"
                                    value={props.filterOwner}
                                    onChange={(e) => props.setFilterOwner(e.target.value)}
                                >
                        ...
                        <div className="space-y-1 mb-0">
                            ...
                            <div className="grid grid-cols-[1fr_auto_1fr] items-center gap-2 bg-muted/50 rounded-2xl px-4 h-12">
                                <input
                                    ...
                                    className="bg-transparent border-none text-xs focus:ring-0 outline-none w-full font-sans"
                                />
